...
const VALIDATION_STATUS_OPTIONS = [
  { value: "https://w3id.org/sciencelive/o/terms/Validated", label: "validated" },
  { value: "https://w3id.org/sciencelive/o/terms/PartiallySupported", label: "partially supported" },
  { value: "https://w3id.org/sciencelive/o/terms/Contradicted", label: "contradicted" },
  { value: "https://w3id.org/sciencelive/o/terms/Inconclusive", label: "inconclusive" },
  { value: "https://w3id.org/sciencelive/o/terms/NotTested", label: "not tested" },
];

const CONFIDENCE_LEVEL_OPTIONS = [
  { value: "https://w3id.org/sciencelive/o/terms/VeryHighConfidence", label: "very high - Extensive evidence, high agreement with original" },
  { value: "https://w3id.org/sciencelive/o/terms/HighConfidence", label: "high - Strong evidence, mostly agrees with original" },
  { value: "https://w3id.org/sciencelive/o/terms/Moderate", label: "moderate - Adequate evidence, partial agreement" },
  { value: "https://w3id.org/sciencelive/o/terms/LowConfidence", label: "low - Limited evidence, significant disagreement" },
  { value: "https://w3id.org/sciencelive/o/terms/VeryLowConfidence", label: "very low - Minimal evidence, major disagreement" },
];

const ANALYSIS_TYPE_OPTIONS = [
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-DataAnalysis", label: "Data Analysis" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-DataPreprocessing", label: "Data Preprocessing" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-DescriptiveStatistics", label: "Descriptive Statistics" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-GroupComparison", label: "Group Comparison (t-test, ANOVA, etc.)" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-RegressionAnalysis", label: "Regression Analysis" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-CorrelationAnalysis", label: "Correlation Analysis" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-MultilevelAnalysis", label: "Multilevel Analysis (mixed/hierarchical models)" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-ClassPrediction", label: "Class Prediction" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-ClassDiscovery", label: "Class Discovery (clustering)" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-AlgorithmEvaluation", label: "Algorithm Evaluation" },
  { value: "https://w3id.org/sciencelive/o/terms/dtreg-FactorAnalysis", label: "Factor Analysis" },
];
...
export default function FORRTKLReplicationOutcome({
  ...
  const schema = z.object({
    ...
    "kl-proof": z.string().url("Must be a valid URL").optional().or(z.literal("")),
  ...
  const { Form } = useFormedible({
    ...
    formOptions: {
      ...
      onSubmit: async ({ value }) => {
        ...
        if (!submitData["kl-proof"]) delete submitData["kl-proof"];
        if (!submitData["kl-analysis-type"]) delete submitData["kl-analysis-type"];
        if (!submitData["kl-key-result"]) delete submitData["kl-key-result"];

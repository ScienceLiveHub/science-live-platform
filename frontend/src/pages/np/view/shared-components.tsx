...
export function ExternalUriLink({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      className={cn(
        "text-link hover:underline inline-flex items-center gap-1 break-all",
        className,
      )}
    >
      {label || uri}
    ...
    <div className={className}>
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          href={href || uri}
          rel="noreferrer"
          className="font-bold text-link hover:underline inline-flex items-center gap-1 break-all text-md"
        >
          {label}
        </a>
      </div>

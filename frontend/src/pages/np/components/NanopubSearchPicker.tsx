 ...
 * further processing (e.g. importing into Zotero).  Includes the ability to quickly
 * preview the text content of any nanopub search result without leaving the page.
 *

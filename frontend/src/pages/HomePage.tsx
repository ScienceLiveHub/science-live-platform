    ...
    <div className="home-page">
      ...
      <header className="hero">
        <div className="hero-content">
          ...
          <p className="tagline">Transform research into connected knowledge through stackable knowledge bricks</p>
          <p className="subtitle">Making scientific work FAIR: Findable, Accessible, Interoperable, Reusable</p>
          ...
          <div className="cta-buttons">
            ...
            <a href="https://github.com/ScienceLiveHub" target="_blank" rel="noopener noreferrer" className="btn btn-secondary">
          ...
          <div className="timeline">
            ...
            <div className="timeline-item complete">
              ...
              <div className="timeline-content">
                ...
                <p>Supabase + PostgreSQL integration</p>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>Transform research findings into FAIR nanopublications using intuitive templates</p>
              <Link to="/test-nanopub" className="feature-link">
            ...
            <div className="feature-card">
              ...
              <p>Link findings across studies, creating a connected knowledge graph</p>
            ...
            <div className="feature-card">
              ...
              <h3>Get Credit</h3>
              <p>Proper attribution and credit for every contribution through ORCID integration</p>
            ...
            <div className="feature-card">
              ...
              <p>Search and find relevant nanopublications across the scientific community</p>
              <span className="feature-badge">Coming Soon</span>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>Track how your knowledge bricks are used and built upon by others</p>
              <span className="feature-badge">Coming Soon</span>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="info-content">
            <div className="info-text">
              ...
              <p>
                Nanopublications are the smallest units of publishable information. Each nanopublication is:
              </p>
              <ul className="info-list">
                <li><strong>Structured:</strong> Clear assertion, provenance, and publication info</li>
                <li><strong>Linked:</strong> Connected to other knowledge using standard vocabularies</li>
                <li><strong>Attributed:</strong> Properly credited to its creator</li>
                <li><strong>Verifiable:</strong> Cryptographically signed and trustworthy</li>
                <li><strong>Permanent:</strong> Immutable and permanently accessible</li>
              </ul>
            </div>
            ...
            <div className="info-visual">
              <div className="nanopub-structure">
                <div className="np-box assertion">
                  <h4><i className="fas fa-file-alt"></i> Assertion</h4>
                  <p>The actual claim or statement</p>
                </div>
                <div className="np-box provenance">
                  <h4><i className="fas fa-microscope"></i> Provenance</h4>
                  <p>Where did this come from?</p>
                </div>
                <div className="np-box pubinfo">
                  <h4><i className="fas fa-user-circle"></i> Publication Info</h4>
        ...
        <div className="container">
          ...
          <div className="team-grid">
            <div className="team-card">
              <h3>Project Lead</h3>
              <p><strong>Anne Fouilloux</strong></p>
              <p>VitenHub AS</p>
            </div>
            
            <div className="team-card">
              <h3>Technical Architecture</h3>
              <p><strong>Knowledge Pixels</strong></p>
              <p>+ Prophet Town</p>
            </div>
            
            <div className="team-card">
              <h3>Semantic Consulting</h3>
              <p><strong>Barbara Magagna</strong></p>
              <p>Mabablue</p>
            </div>
            
            <div className="team-card highlight">
              <h3>Funded By</h3>
              <p><strong>Astera Institute</strong></p>
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="https://sciencelive4all.org" target="_blank" rel="noopener noreferrer">
                    <i className="fas fa-globe"></i> Website
                  </a>
                </li>
                <li>
                  <a href="https://github.com/ScienceLiveHub" target="_blank" rel="noopener noreferrer">
                    <i className="fab fa-github"></i> GitHub
                  </a>
                </li>
                <li>
                  <a href="http://nanopub.org/" target="_blank" rel="noopener noreferrer">
                    <i className="fas fa-external-link-alt"></i> Nanopublications
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li>
                  <a href="https://calendly.com/anne-fouilloux/30min" target="_blank" rel="noopener noreferrer">
                    <i className="fas fa-calendar-alt"></i> Book a Call
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/company/sciencelive" target="_blank" rel="noopener noreferrer">
